...
export class migration1688640829355 implements MigrationInterface {
    name = 'migration1688640829355'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            CREATE TABLE \`users_groups\` (
                \`group_id\` int NOT NULL,
                \`user_id\` int NOT NULL,
                INDEX \`IDX_d665a3539878a2669c5ff26966\` (\`group_id\`),
                INDEX \`IDX_3f4a7469c59e1c47a02a4f9ac5\` (\`user_id\`),
                PRIMARY KEY (\`group_id\`, \`user_id\`)
            ) ENGINE = InnoDB
        `);
        await queryRunner.query(`
